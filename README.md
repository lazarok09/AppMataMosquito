...
App Mata Mosquito é uma aplicação estilo mini game que visa utilizar funçoes nativas do Javascript de forma simples a fim de criar um jogo sem muita condificação extensa. Pela simplicidade algumas más práticas como passar parâmetros em URL são comuns mas como a aplicação é um exercício conciente de recursos low level não há problema em incluir isso.
...
## Ou clonar o repositório e executar o index.html
